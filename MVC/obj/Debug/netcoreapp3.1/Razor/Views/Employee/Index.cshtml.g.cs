#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Employee\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e743a6592e6f238069eac0d1ff0ff2887a7e3f37"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e743a6592e6f238069eac0d1ff0ff2887a7e3f37", @"/Views/Employee/Index.cshtml")]
    ...
    <script>
     ...
     ");
        ...
        function Get(id) {
            ...
            $.ajax({
 ");
                WriteLiteral(@"               url: ""/AccountRole/GetById"",
                type: ""GET"",
                data: { 'key': id },
                success: function (result) {
                    var data = result[""result""];
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#Bi");
                WriteLiteral(@"rthPlace').val(data.birthPlace);
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result != null) {
                        ...
                        ");
                WriteLiteral(@"$('#ValidationNIK').css('visibility', 'hidden');
                    }
                }
            })
        });
                    ...
                    success: function (result) {
                        ...
                        if (data != """") {
                            ...
                            $('#Email').focus(function () {
                                $('#Valid");
                WriteLiteral(@"ationEmail').css('visibility', 'hidden');
                            });
                        }
                    }
                })
