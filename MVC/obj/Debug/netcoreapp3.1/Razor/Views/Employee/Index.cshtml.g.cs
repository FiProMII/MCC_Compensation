#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Employee\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "18acbb5d1ae9f892547da82b979420dbe08f308f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"18acbb5d1ae9f892547da82b979420dbe08f308f", @"/Views/Employee/Index.cshtml")]
    ...
    <script>
     ...
     ");
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        if (i >= 8) {
                            var roleCheckbox = '<div class=""input-group"" id=""ulCheckbox""><ul class=""icheck-list"" id=""roleCheckbox""><li><input type=""checkbox"" class=""check"" data-checkbox=""icheckbox_line-red"" value=""' + data[i].roleID + '""> ' + data[i].roleName + ' </li></ul");
                WriteLiteral(@" ></div>';
            ...
            $.ajax({
                type: ""GET"",
          ");
                WriteLiteral(@"      url: '/Department/Get',
                headers: { ""Authorization"": sessionStorage.token },
                success: function (result) {
                    var data = result['result']
                    for (var i = 0; i < data.length; i++) {
            ...
            $(""select#PositionID"").on('change', function () {
                ...
                var selectedDepartment = $('#DepartmentDropdown option:selected').val();
                GetManage");
                WriteLiteral(@"rDropdown(selectedPosition, selectedDepartment)
            })
       ...
       ");
        ...
        $('#NIK').change(function () {
");
                WriteLiteral(@"            var nik = this.value;
            $.ajax({
                    ...
                    $.ajax({
                        ...
                        error: function (error) {
                            Swal.fire({
                                ...
                                text: 'Something went wrong!',
                                footer: '<a href>Your");
                WriteLiteral(" Work cannot be saved</a>\'\r\n                            })\r\n                        },\r\n                    });\r\n                }\r\n            });\r\n        }\r\n\r\n    </script>\r\n");
            }
            );
        }
