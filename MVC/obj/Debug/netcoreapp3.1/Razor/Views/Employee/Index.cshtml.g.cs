#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Employee\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f67fc4e6a2952a2aa7e779b410cba92bc56bb77f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f67fc4e6a2952a2aa7e779b410cba92bc56bb77f", @"/Views/Employee/Index.cshtml")]
...
");
      ...
      ");
            ...
            $.ajax({
                ...
                success: function (result) {
                   ...
                   ");
                WriteLiteral(@" $('#BirthDate').val(moment(data.birthDate).format('YYYY-MM-DD'));
  ...
  ");
                WriteLiteral(@"              $('#ValidationEmail').hide();
            }
            else {
                $.ajax({
        ...
        $('#BirthD");
                WriteLiteral(@"ate').on('change',function() {
            var date = new Date();
