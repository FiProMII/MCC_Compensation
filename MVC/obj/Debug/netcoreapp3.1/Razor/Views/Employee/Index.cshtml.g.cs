#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Employee\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2fb723f31c56e8ca708f1caae8f7e640092faf96"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2fb723f31c56e8ca708f1caae8f7e640092faf96", @"/Views/Employee/Index.cshtml")]
...
#nullable disable
                                    ...
                                    <div class=""form-group"" id=""nikGroup"">
                                        ...
                                        <div class=""controls"">
                                            <div class=""input-group"">
                                                ...
                                                ");
            WriteLiteral(@"<div class=""input-group-addon""><i class=""ti-id-badge""></i></div>
                                            </div>
                                        </div>
                            ...
                            <div class=""row"">
                                <div class=""col-md-6"">
                                    <div class=""form-group"" id=""emailGroup"">
                                        ...
                                        ");
            WriteLiteral(@"        <div class=""input-group-addon""><i class=""ti-email""></i></div>
                                            </div>
                                        </div>
                                ...
                                <div class=""col-md-6"">
                                    <div class=""form-group"" id=""phoneGroup"">
                                        ...
                                        <div class=""controls"">
                                            <div class=""input-group"">
                                                <input type=""number"" class=""form-control"" name=""Phone"" id=""Phone"" placeholder=""Enter Phone Number"" required data-validation-containsnumber-regex=""(\d)+"" data-validation-contai");
            WriteLiteral(@"nsnumber-message=""No Characters Allowed, Only Numbers"">
    ...
    ");
                                    ...
                                    <div class=""form-group"">
                                        ...
                                        <div class=""controls"">
                                            <div class=""input-group"">
                                                ...
                                                <div ");
            WriteLiteral(@"class=""input-group-addon""><i class=""ti-map-alt""></i></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            WriteLiteral(@"                </div>
                                ...
                                <div class=""col-md-6"">
                                    <div class=""form-group"">
                                        ...
                                        <div class=""controls"">
                                            <select class=""form-control custom-select"" id=""DepartmentDropdown"" name=""DepartmentDropdow");
            ...
            WriteLiteral(@"-select"" id=""ManagerNIK"" name=""ManagerNIK"">
...
");
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        if (i >= 8) {
                            ...
                            $(""#formCheckbox"").append(ro");
                WriteLiteral(@"leCheckbox);
                        }
                        else if (i <= 3) {
   ...
   ");
                WriteLiteral(@"                     ""data"": 'position',
                        ""render"": function (data, type, row, meta) {
                            return row['positionName'] + ' - ' + row['departmentName'];
                        }
                    },
                    {
                        ""data"": 'manager',
                    ...
                    },
                    {
                        ...
                        ""render"": function (data, type, row, meta) {
                            return '<button class=""btn btn-sm btn-success waves-effect waves-light"" data-toggle=""tooltip"" data-placement=""top"" title=""Edit""  onclick=""Get(\'' + row['nik'] + '\')""><i class =""mdi mdi-table-edit""></i> Edit</button> ' +
                                '<button class=""btn btn-sm btn-danger waves-effect waves-light"" data-toggle=""tooltip"" data-placement=""top"" title=""");
                WriteLiteral(@"Delete"" onclick=""Delete(\'' + row['nik'] + '\')""><i class =""mdi mdi-delete""></i> Delete</button>'
                        }
                    }
                ]
            });
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (selectedPosition != ""RM"") {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            if (data[i].departmentID == selectedDepartment) {
                                managerDropdown += '<option value=""' + data[i].nik + '"">' + data[i].employeeN");
        ...
        function Get(id) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#Joi");
                WriteLiteral(@"nDate').val(moment(data.joinDate).format('YYYY-MM-DD'));
        ...
        function reset() {
            ...
            $('input:checkbox').removeAttr('checked');
           ");
                WriteLiteral(@" $('#NIK').removeAttr('readonly');
        ...
        $('#Phone').keyup(function () {
            var phone = $('#Phone').val();
            if (phone == """") {
                $('#phoneGroup').removeClass('has-danger').removeClass('has-success'");
                WriteLiteral(@").addClass('has-warning');
                $('#ValidationPhone').hide();
            }
            else {
                $.ajax({
        ...
        $('#BirthDate').on('change',function() {
            var date = new Date();
            var birth");
                WriteLiteral(@"Date = $('#BirthDate').val();
