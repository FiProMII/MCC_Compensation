#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Employee\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0155ce50241e291a56c31dafa796fb12445a3c34"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0155ce50241e291a56c31dafa796fb12445a3c34", @"/Views/Employee/Index.cshtml")]
    ...
    <script>
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (selectedPosition != ""RM"") {
                                ...
                                manager");
                WriteLiteral(@"Dropdown = '<option value=""-1"">Please select a manager</option>';
                                for (var i = 0; i < data.length; i++) {
       ...
       ");
        ...
        function Get(id) {
            ...
            $.ajax({
                u");
                WriteLiteral(@"rl: ""/AccountRole/GetById"",
                type: ""GET"",
                data: { 'key': id },
                success: function (result) {
                    var data = result[""result""];
      ...
      ");
        ...
        $('#Email').keyup(function () {
            ...
            if (email == """") {
                $('#emailGroup').");
                WriteLiteral(@"removeClass('has-danger').removeClass('has-success').addClass('has-warning');
                $('#ValidationEmail').hide();
            }
            else {
                $.ajax({
