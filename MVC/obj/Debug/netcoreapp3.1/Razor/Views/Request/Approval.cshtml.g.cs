#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Approval.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7df6f76f316c7098b54682d33cd14eca4f319305"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7df6f76f316c7098b54682d33cd14eca4f319305", @"/Views/Request/Approval.cshtml")]
            ...
            if (id != null) {
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#DepartmentName').html(dat");
                WriteLiteral(@"a.employee.position.department.departmentName)
                        ...
                        for (var i = 0; i < data.documents.length; i++) {
                            if (data.documents[i].link.search(/(.*?)\.(pdf|PDF)$/)) {
                                var documentList = '<a target=""_blank"" href=""' + data.documents[i].link
            ");
                WriteLiteral(@"                        + '""><img src=""/src/images/images.png"" width=""50"">' + data.documents[i].documentName + '</>'
                            } else if (data.documents[i].link.search(/(.*?)\.(jpg|jpeg|JPG|JPEG)$/)) {
                                var documentList = '<a target=""_blank"" href=""' + data.documents[i].link
