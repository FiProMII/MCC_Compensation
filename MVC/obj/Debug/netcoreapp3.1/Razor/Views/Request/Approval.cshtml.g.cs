#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Approval.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c6554290f8231b29fd2f86892c96a562d6ecf8c8"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c6554290f8231b29fd2f86892c96a562d6ecf8c8", @"/Views/Request/Approval.cshtml")]
            ...
            if (id != null) {
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#Man");
                WriteLiteral(@"agerName').html(data.employee.manager.employeeName)
                        ...
                        for (var i = 0; i < data.documents.length; i++) {
                            ...
                            if (data.documents[i].link.search(/(.*?)\.(pdf|PDF)$/)) {
                                var documentList = '<a target=""_blank"" href=""' + data.documents[i].link
                                    + '""><img src=""/src/images/images.png"" width=""50"">' + data.documents[i].documentName + '</><br/>'
   ");
                WriteLiteral(@"                         } else if (data.documents[i].link.search(/(.*?)\.(jpg|jpeg|JPG|JPEG)$/)) {
                                var documentList = '<a target=""_blank"" href=""' + data.documents[i].link
