#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "edff7bf062fe38a6d3e81c178516be25deaff008"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"edff7bf062fe38a6d3e81c178516be25deaff008", @"/Views/Request/Index.cshtml")]
    ...
    <div class=""modal-dialog modal-lg"">
        <div class=""modal-content"">
            ...
            <div class=""modal-footer"">
                <button type=""bu");
            WriteLiteral(@"tton"" class=""btn btn-outline-secondary btn-rounded waves-effect text-left"" data-dismiss=""modal"" id=""close"" style=""visibility: visible"">Close</button>
                <button type=""submit"" class=""btn btn-danger btn-rounded waves-effect text-left"" data-dismiss=""modal"" id=""reject"" style=""visibility: visible"">Reject</button>
                <button type=""submit"" class=""btn btn-success btn-rounded waves-effect text-left"" data-dismiss=""modal"" id=""approve"" style=""visibility: visible"">Approve</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
        ...
        ");
                ...
                WriteLiteral(@"     return moment(data).format('DD/MM/YYYY');
                    ...
                    },
                    {
                        ""data"": 'requestID',
                        ""render"": function (data, type, row, meta) {
                            return '<button class=""btn btn-outline-info waves-effect waves-light"" data-toggle=""tooltip"" data-placement=""top"" t");
                WriteLiteral(@"itle=""Detail Information"" onclick=""GetDetail(\'' + row['requestID'] + '\')""><i class=""fa fa-info-circle""></i> Details</button>'
                        }
                    }
                ]
            })
                ...
                WriteLiteral(@"""result""];
                    ...
                    for (var i = 0; i < data.documents.length; i++) {
                        if (data.documents[i].link.match(/(.*?)\.(pdf|PDF)$/)) {
                            var documentList ");
                WriteLiteral(@"= '<a target=""_blank"" href=""' + data.documents[i].link
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        var statusList = '<tr><t");
                WriteLiteral(@"h id=""Status"">' + data[i].statusName + '</th>'
