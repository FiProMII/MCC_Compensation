#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bbf4756863cd29e9185fa569495a7926563c1271"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bbf4756863cd29e9185fa569495a7926563c1271", @"/Views/Request/Index.cshtml")]
        ...
        function defaultTable() {
            $('#table_id').DataTable({
                ...
                ""columns"": [
                    ...
                    { ""data"": 'employee.manager.employeeName' },
            ");
                WriteLiteral(@"        { ""data"": 'compensation.compensationName' },
                    {
                        ""data"": 'eventDate',
                        ""render"": function (data, type, row) {
                            return moment(data).format('DD/MM/YYYY');
        ...
        function GetDetail(id) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#DepartmentName').html(data.employee.pos");
                WriteLiteral(@"ition.department.departmentName)
                    ...
                    for (var i = 0; i < data.documents.length; i++) {
                        if (data.documents[i].link.match(/(.*?)\.(pdf|PDF)$/)) {
                            var documentList = '<a target=""_blank"" href=""' + data.documents[i].link
                                + '""><img src=""/lib/src/images/pdf.png"" width=""30"">' + da");
                WriteLiteral(@"ta.documents[i].documentName + '</><br/>'
