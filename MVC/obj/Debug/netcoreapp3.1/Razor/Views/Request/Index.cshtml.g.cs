#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "90f2f48a55fb28584561eef750f9f9269f8abfe4"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"90f2f48a55fb28584561eef750f9f9269f8abfe4", @"/Views/Request/Index.cshtml")]
                        ...
                        <div class=""row"">
                            ...
                            <div class=""col-md-6"">
                                <div class=""form-group row"">
                                    ...
                                    <div class=""col-md-8"">
       ");
            WriteLiteral(@"                                 <p class=""form-control-static"" id=""JoinDate""></p>
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                        ...
                        <div class=""row"">
                            ...
                            <div class=""col-md-6"">
                                <div class=""form-group row"">
                                    ...
                                    <div class=""col-md-8"">
                 ");
            WriteLiteral(@"                       <p class=""form-control-static"" id=""Document""></p>
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        <div class=""row is-hidden"" id=""Note"">
                            <div class=""col-md-12"">
                                <div class=""form-group row has-danger"">
                                    <label class=""control-label text-right col-md-2 text-danger"">Rejection Description:</label>
                                    <div class=""col-md-10"">
                                        <p class=""form-control-feedback"" id=""Reason""></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            WriteLiteral(@"-rounded approval"" id=""reject"" value=""Reject"">Reject</button>
...
<div id=""modalRejected"" class=""modal fade"">
    <div class=""modal-dialog"">
     ...
     ");
            WriteLiteral(@"                   <textarea class=""form-control"" rows=""5"" id=""textArea"" required></textarea>
                    </div>
...
");
            ...
            if (data.includes(""Super Admin"") || data.includes(""RM"") || data.includes(""HR"") || data.includes(""Finance"")) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        var obj = JSON.");
                WriteLiteral(@"parse(JSON.stringify(data));
                        var joinDate = moment(obj.joinDate).format('YYYY');
                        var date = new Date();
                ...
                ""columns"": [
                    {
                        ...
                        ""autowidth"": true,
                        ""render"": func");
                WriteLiteral(@"tion (data, type, row, meta) {
        ...
        fu");
                WriteLiteral(@"nction defaultTable() {
            $('#table_id').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    {
    ...
    ");
                WriteLiteral(@"                },
                    ...
                    },
                    {
                        ...
                        ");
                WriteLiteral(@"    return manager.employeeName;
                        }
                    },
                    {
                        ""data"": 'compensation',
                    ...
                    },
                    {
                        ""data"": 'requestID',
                        ""render"": functi");
                WriteLiteral(@"on (data, type, row, meta) {
                            return '<button class=""btn btn-outline-info waves-effect waves-light"" data-toggle=""tooltip"" data-placement=""top"" title=""Detail Information"" onclick=""GetDetail(\'' + row['requestID'] + '\')""><i class=""fa fa-info-circle""></i> Details</button>'
                        }
                    }
                ]
        ...
        function GetDetail(id) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#Manage");
                WriteLiteral(@"rName').html(data.manager)
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                               ...
                               ");
                WriteLiteral(@"     + '<th id=""ApprovalDate"">' + moment(data[i].approvalDate).format('DD MM YYYY') + '</th></tr>'
        ...
        $('#formApproval').submit(function (event) {
            ...
            if (statusName == ""Reject"") {
                ...
                $('#saveChange').on('click',function (event) {
                    event.preventDefault()
                    UpdateStatusVM.note = $('#text");
                WriteLiteral(@"Area').val();
                    $.ajax({
                        type: ""POST"",
