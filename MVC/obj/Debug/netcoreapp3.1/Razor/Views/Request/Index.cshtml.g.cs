#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "83113ba23e548038e9a4df7cdb20f44a7a4c7628"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"83113ba23e548038e9a4df7cdb20f44a7a4c7628", @"/Views/Request/Index.cshtml")]
        ...
        function GetDetail(id) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#JoinDate').html(mo");
                WriteLiteral(@"ment(data.joinDate).format('DD MMMM YYYY'))
                ...
                $.ajax({
                    ...
                    success: function () {
                        Swal.fire({
                            ...
                            confirmButtonText:
 ");
                WriteLiteral(@"                               '<i class=""fa fa-thumbs-up""></i> Great!',
                            confirmButtonAriaLabel: 'Thumbs up, great!',
                            allowOutsideClick: false,
                        }).then((result) => {
                            if (result.isConfirmed) {
