#pragma checksum "C:\Users\LENOVO\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "835df86d1357ee3b96cb52e6f0aad3dfa148d2ae"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"835df86d1357ee3b96cb52e6f0aad3dfa148d2ae", @"/Views/Request/Index.cshtml")]
...
<div id=""modal"" class=""modal fade"" tabindex=""-1"" role=""dialog"" aria-labelledby=""myLargeModalLabel"" aria-hidden=""true"" style=""display: none;"">
 ...
 ");
            WriteLiteral(@"                       <button type=""button"" class=""btn-secondary btn-rounded waves-effect waves-light"" data-dismiss=""modal"" id=""close"" onclick=""reset()"">Close</button>
                        <button type=""submit"" class=""btn btn-danger btn-rounded waves-effect waves-light"" id=""reject"" value=""3"">Reject</button>
                        <button type=""submit"" class=""btn btn-success btn-rounded waves-effect waves-light"" id=""approve"" value=""2"">Approve</button>
                    </div>
                </form>
            </div>
        </div>
      ...
      ");
        ...
        function GetDetail(id) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#ManagerName').html(data.employee.man");
                WriteLiteral(@"ager.employeeName)
                    ...
                    for (var i = 0; i < data.documents.length; i++) {
                        if (data.documents[i].link.match(/(.*?)\.(pdf|PDF)$/)) {
                            ...
                            var do");
                WriteLiteral(@"cumentList = '<a target=""_blank"" href=""' + data.documents[i].link
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                         ...
                         ");
                WriteLiteral(@"       $('#Status').append(statusList);
                            }
                        }
                    })
                }
        ...
        $('#formApproval').submit(function (event) {
            ...
            $.ajax({
                ...
                WriteLiteral(@"'Bearer ' + localStorage.token },
