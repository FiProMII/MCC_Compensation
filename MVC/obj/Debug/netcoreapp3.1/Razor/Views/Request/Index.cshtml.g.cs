#pragma checksum "C:\Users\LENOVO\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a6e230472f27e41fa807974f9aa7b87cfd0f7708"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a6e230472f27e41fa807974f9aa7b87cfd0f7708", @"/Views/Request/Index.cshtml")]
...
");
           ...
           ");
                WriteLiteral(@"             }
                    ...
                    },
                    {
                        ""data"": 'requestID',
                        ""render"": function (data, type, row, meta) {
                            return '<button class=""btn btn-outline-danger waves-effect waves-light"" data-toggle=""tooltip"" data-placement=""top"" title=""Approval Needed"" onclick=""GetDetail(\'' + row['requ");
                WriteLiteral(@"estID'] + '\')""><i class=""fa fa-info-circle""></i> Approval</button>'
                        }
                    }
                ]
            })
 ...
 ");
            ...
            ");
                ...
                WriteLiteral(@"ormat('DD/MM/YYYY');
                    ...
                    },
                    {
                        ""data"": 'requestID',
                        ""render"": function (data, type, row, meta) {
                            return '<button class=""btn btn-outline-info waves-effect waves-light"" data-toggle=""tooltip"" data-placement=""top"" title=""Detail Information"" onclick=""GetDetail(\'' + row['reque");
                WriteLiteral(@"stID'] + '\')""><i class=""fa fa-info-circle""></i> Details</button>'
                        }
                    }
                ]
            })
        ...
        var statusID;
        $");
                WriteLiteral(@"('.btn').on('click', function () {
            debugger;
