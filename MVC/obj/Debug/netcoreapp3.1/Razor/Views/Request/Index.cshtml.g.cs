#pragma checksum "C:\Users\LENOVO\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b03f631e2eddd7e298701c66582ad9e8784615a8"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b03f631e2eddd7e298701c66582ad9e8784615a8", @"/Views/Request/Index.cshtml")]
...
");
   ...
   ");
                ...
                ""columns"": [
                    ...
                    { ""data"": 'requestID' },
                    ");
                WriteLiteral(@"{ ""data"": 'employeeName' },
                    {
                        ""data"": 'joinDate',
...
");
                ...
                WriteLiteral(@"er"": function (data, type, row) {
                    ...
                    },
                    {
                        ""data"": 'requestID',
                        ""render"": function (data, type, row, meta) {
                            return '<button class=""btn btn-outline-info waves-effect");
                WriteLiteral(@" waves-light"" data-toggle=""tooltip"" data-placement=""top"" title=""Detail Information"" onclick=""GetDetail(\'' + row['requestID'] + '\')""><i class=""fa fa-info-circle""></i> Details</button>'
                        }
                    }
                ]
            })
        ...
        function GetDetail(id) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#Reques");
                WriteLiteral(@"tID').html(data.requestID)
                            ...
                            for (var i = 0; i < data.length; i++) {
                                if (data[i].link.match(/(.*?)\.(pdf|PDF)$/)) {
                                    var documentList = '<a target=""_blank"" href=""' + data[i].link
                                        + '""><img src=""/lib/src/images/pdf.png"" width=""30"">' + data[i].documentName + ");
                WriteLiteral(@"'</><br/>'
...
");
                WriteLiteral(@"                        type: ""GET"",
                        ...
                        error: function () {
                            Swal.fire({
                                ...
                                title: 'Oops...',
                               ");
                WriteLiteral(@" text: 'Something in Approval Status went wrong!',
                                footer: '<a href>Why do I have this issue?</a>'
                            })
                        }
                    })
        ...
        $('#formApproval').submit(function (event) {
            ...
            var reque");
                WriteLiteral(@"stID = parseInt(document.getElementById(""RequestID"").innerHTML);
                    ...
                    success: function () {
                        Swal.fire({
                            ...
                            confirmButtonText:
                                '<i class=""fa fa-thumbs-up""></i> Great!',
 ");
                WriteLiteral(@"                           confirmButtonAriaLabel: 'Thumbs up, great!',
                            allowOutsideClick: false,
                        }).then((result) => {
                            if (result.isConfirmed) {
                                $('#table_id').DataTable().ajax.reload();
