#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7ff630201aea6766185933669a31153660f1194b"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7ff630201aea6766185933669a31153660f1194b", @"/Views/Request/Index.cshtml")]
    ...
    ");
                ...
                $('#RequestDisable').on('click', function () {
                    Swal.fire({
                        icon: ""info"",
                        title: ""Sorry..."",
                        text: ""You can't make a request because you haven't joined for more than 1 year"",
                    })
               ");
                WriteLiteral(@" })
            }
      ...
      ");
                ...
                WriteLiteral(@"ata, type, row, meta) {
                    ...
                    },
                    {
                        ...
                        ""render"": function (data, type, row) {
                            ret");
                WriteLiteral(@"urn moment(data).format('DD/MM/YYYY');
                        }
                    },
                    {
                        ""data"": 'requestID',
...
");
        ...
        function GetDetail(id) {
            ...
            $.ajax({
                ...
                ");
                WriteLiteral(@"    $('#PositionName').html(data.positionName)
        ...
        $('#formApproval').submit(function (event) {
            ...
            if (statusName == ""Reject"") {
                ...
                ");
                WriteLiteral(@"        headers: { 'Authorization': 'Bearer ' + localStorage.token },
                ...
                $.ajax({
                    ...
                    success: function () {
                        Swal.fire({
                            ...
                            html:
                            ");
                WriteLiteral(@"    'you succeeded in <b>giving approval</b> ',
                            focusConfirm: false,
                            confirmButtonText:
                                '<i class=""fa fa-thumbs-up""></i> Great!',
                            confirmButtonAriaLabel: 'Thumbs up, great!',
