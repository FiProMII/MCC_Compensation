#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0223fee0216cbf684389fbb80424498a32714fd2"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0223fee0216cbf684389fbb80424498a32714fd2", @"/Views/Request/Index.cshtml")]
...
");
        ...
        function pendingTable() {
            $('#table_id').DataTable({
                ...
                ""columns"": [
                    ...
                    {
                        ");
                WriteLiteral(@"""data"": 'employee.joinDate',
                    ...
                    },
                    {
                        ...
                        ""render"": function (data, type, row, meta) {
                         ");
                WriteLiteral(@"   return '<button class=""btn btn-outline-danger waves-effect waves-light"" data-toggle=""tooltip"" data-placement=""top"" title=""Approval Needed"" onclick=""GetDetail(\'' + row['requestID'] + '\')""><i class=""fa fa-info-circle""></i> Approval</button>'
                        }
                    }
                ]
            })
  ...
  ");
        ...
        function GetDetail(id) {
         ...
         ");
                WriteLiteral(@"           $('#JoinDate').html(moment(data.employee.joinDate).format('DD MMMM YYYY'))
                    ...
                    for (var i = 0; i < data.documents.length; i++) {
                        if (data.documents[i].link.match(/(.*?)\.(pdf|PDF)$/)) {
                            ...
                            var documentList = '<a target=""_bla");
                WriteLiteral(@"nk"" href=""' + data.documents[i].link
