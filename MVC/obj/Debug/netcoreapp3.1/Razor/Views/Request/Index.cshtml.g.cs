#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "712790abfb45bcc8fb3094a61171493c42f50bbc"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"712790abfb45bcc8fb3094a61171493c42f50bbc", @"/Views/Request/Index.cshtml")]
...
<div id=""modal"" class=""modal fade"" tabindex=""-1"" role=""dialog"" aria-labelledby=""myLargeModalLabel"" aria-hidden=""true"" style=""display: none;"">
    <div class=""modal-dialog modal-lg"">
        <div class=""modal-content"">
                        ...
                        <div class=""row"">
                            <div class=""col-md-6"">
                                <div class=""form-group row"">
                                    ...
                                    <div class=""col-md-8"">
                             ");
            WriteLiteral(@"           <p class=""form-control-static"" id=""Requester""></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            WriteLiteral(@"ol-md-4"">Relation Manager:</label>
                                    <div class=""col-md-8"">
                        ...
                        <div class=""row"">
                            <div class=""col-md-6"">
                                <div class=""form-group row"">
                                    ...
                                    <div class=""col-md-8"">
     ");
            WriteLiteral(@"                                   <p class=""form-control-static"" id=""RequestID""></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class=""row"">
                            ...
                            <div class=""col-md-6"">
                                <div class=""form-group row"">
                                    <label class=""control-label text-right col-md-4"">Compensat");
            WriteLiteral(@"ion Type:</label>
                                    <div class=""col-md-8"">
...
<!-- sample modal content -->
<div id=""statusModal"" class=""modal fade"" tabindex=""-1"" role=""dialog"" aria-labelledby=""myLa");
            WriteLiteral(@"rgeModalLabel"" aria-hidden=""true"" style=""display: none;"">
    <div class=""modal-dialog modal-lg"">
        <div class=""modal-content"">
            <div class=""modal-header"">
                <h4 class=""modal-title ribbon ribbon-primary"" id=""myLargeModalLabel"">Approval Status</h4>
                <button type=""button"" class=""close"" data-dismiss=""modal"" aria-hidden=""true"">×</button>
            </div>
            <div class=""modal-body"">
                <form class=""form-horizontal"" role=""form"">
      ...
      ");
                WriteLiteral(@"              $('#modal').modal('show');
                    ...
                    for (var i = 0; i < data.documents.length; i++) {
                        if (data.documents[i].l");
                WriteLiteral(@"ink.match(/(.*?)\.(pdf|PDF)$/)) {
