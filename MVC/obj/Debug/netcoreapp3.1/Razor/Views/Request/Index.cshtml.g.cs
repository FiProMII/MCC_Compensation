#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8bc1ad71ccf3a67a2709cf339912b3ce7d8fdce2"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8bc1ad71ccf3a67a2709cf339912b3ce7d8fdce2", @"/Views/Request/Index.cshtml")]
...
");
        ...
        $('#View').on('change', function () {
            ...
            urlS");
                WriteLiteral(@"tring = ""/Request/RequestList"";
            if (value == '0') {
                dataStatus = ""Pending"";
                pendingTable();
                $('#reject').show();
                        ...
                        success: function (result) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                if (data[i].link.match(/(.*?)\.(pdf|PDF)$/)) {
                                 ");
                WriteLiteral(@"   var documentList = '<a target=""_blank"" href=""' + data[i].link
                        ...
                        error: function () {
                            Swal.fire({
                                ...
                                footer: '<a href>Why do I have this is");
                WriteLiteral(@"sue?</a>'
                            })
                        }
                    })
