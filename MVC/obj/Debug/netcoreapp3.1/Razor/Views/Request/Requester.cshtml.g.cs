#pragma checksum "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Requester.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6153e17e8094a5bd1fa8ed050dc0d14d883945b7"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6153e17e8094a5bd1fa8ed050dc0d14d883945b7", @"/Views/Request/Requester.cshtml")]
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    var data = JSON.parse(JSON.stringify(result['result']));
                    for (var i = 0; i < data.length; i++) {
                        compensationDropdown += '<option value=""' + data[i].compensationID + '"">' + data[i].compensationName + '</option>';
                        compensationValue.set(d");
                WriteLiteral(@"ata[i].compensationName, data[i].cost)
                    }
            ...
            $("".add"").click(function () {
                ...
                if (total_element < max) {
                    ...
                    $(""#div_"" + nextindex).append(""<div class='form-group'><div id='remove_""
                        ...
                        + nextindex + ""' accept='image/jpg, image/jpeg,");
                WriteLiteral(@" .pdf' required /></div>""
...
#nullable restore
#line 212 "C:\Users\Acer\source\repos\MCC_Compensation\MVC\Views\Request\Requester.cshtml"
