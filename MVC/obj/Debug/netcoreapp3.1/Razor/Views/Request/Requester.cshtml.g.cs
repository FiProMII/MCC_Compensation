#pragma checksum "C:\Users\LENOVO\source\repos\MCC_Compensation\MVC\Views\Request\Requester.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "023bc09e56570b4db928737e61dc420cae53e725"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"023bc09e56570b4db928737e61dc420cae53e725", @"/Views/Request/Requester.cshtml")]
...
#nullable restore
#line 10 "C:\Users\LENOVO\source\repos\MCC_Compensation\MVC\Views\Request\Requester.cshtml"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: ""GET"",
                url: '/C");
                WriteLiteral(@"ompensation/Get',
                success: function (result) {
                    var data = result['result']
                    for (var i = 0; i < data.length; i++) {
                        var compensationDropdown = '<option>Please select a compensation type</option>'
     ...
     ");
                WriteLiteral(@"           var split_id = lastid.split(""_"");
        ...
        $(""select#CompensationID"").on('change', function () {
            var selectedCompensatio");
                WriteLiteral(@"nText = $('#CompensationID option:selected').text();
