#pragma checksum "C:\Users\LENOVO\source\repos\MCC_Compensation\MVC\Views\Status\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ea88744e81cb3566b7af812326f2a26927823e77"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ea88744e81cb3566b7af812326f2a26927823e77", @"/Views/Status/Index.cshtml")]
...
<div class=""modal fade bs-modal-sm"" tabindex=""-1"" role=""dialog"" aria-labelledby=""mySmallModalLabel"" aria-hidden=""true"" style=""display: none;"">
  ...
  ");
        ...
        var validator = $(""#form"").validate({
            ...
            messages: {
                FirstName: ""<small class='text-danger'>Please enter <code>Status Name.</");
        ...
        function Get(id) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#StatusName').");
                WriteLiteral(@"val(data.statusName);
                    isUpdate = 1;
                }
            });
        }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            Swal.fire(
                                'Deleted!',
   ");
                WriteLiteral(@"                             'Your data has been deleted.',
                                'success'
                            )
                        },
                        error: function (error) {
